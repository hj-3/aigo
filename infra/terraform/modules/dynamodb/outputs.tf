output "table_names" {
  ...
  value = {
    ...
    org_invitations  = aws_dynamodb_table.org_invitations.name
    agent_memory     = aws_dynamodb_table.agent_memory.name
  }
}
...
output "table_arns" {
  ...
  value = {
    ...
    org_invitations  = aws_dynamodb_table.org_invitations.arn
    agent_memory     = aws_dynamodb_table.agent_memory.arn
  }
}
